...
**Screenshot:**  
![Disable Control Panel GPO linked to HQ_Users](../images/04-gpmc-disable-control-panel-gpo.png) – GPMC showing `HQ_Users` selected with the `Disable Control Panel - HQ_Users` GPO linked.
...
**Screenshot:**  
![GPO setting – Prohibit access to Control Panel enabled](../images/05-gpo-setting-disable-control-panel.png) – GPO Editor window showing the **Control Panel** node and the **Prohibit access to Control Panel and PC settings** policy set to **Enabled**.
...
**Screenshot:**  
![Control Panel blocked](../images/06-win10-control-panel-blocked.png) – Windows 10 client showing that access to Control Panel is blocked by Group Policy (restriction error message).
